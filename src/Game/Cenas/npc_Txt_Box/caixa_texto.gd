...
func _txt():
	...
	if id_npc == 2 and Global.indexMercado != 12:
		print("Estado inicial: State.PRONTO")
		hide_textbox()
	...
	elif id_npc == 2 and Global.indexMercado == 12:
	...
	if id_npc == 9  and Global.contador_easter_egg == 9:
		print("Estado inicial: State.PRONTO")
		hide_textbox()
	...
	if id_npc == 10 and Global.indexPrefeitura != 9 and Global.indexEscola != 7 and Global.indexMercado != 11 and Global.index > 5:
		print("Estado inicial: State.PRONTO")
		hide_textbox()
	...
	elif id_npc == 4 and Global.index == 6:
		hide_textbox()
	...
	if id_npc == 5 and Global.indexEscola != 8:
		print("Estado inicial: State.PRONTO")
		hide_textbox()
	...
	elif id_npc == 5 and Global.indexEscola == 8:
	...
	if id_npc == 11 and Global.indexPrefeitura != 10:
		print("Estado inicial: State.PRONTO")
		hide_textbox()
