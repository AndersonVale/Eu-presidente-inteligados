...
func iniciaFalas():
	...
	$NPC_texto.fila_texto("???: Como assim? Você é o presidente hoje é primeiro dia do seu mandato, não lembra?")
	...
	$NPC_texto.fila_texto("Ana: Senhor presidente, mesmo com memória ou não, noss país está cheio de problemas e você deve trabalhar duro para nos ajudar....")
